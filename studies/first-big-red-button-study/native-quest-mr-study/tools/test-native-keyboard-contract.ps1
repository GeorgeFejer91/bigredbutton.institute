...
$sourceChecks = [ordered]@{
    ...
    nameUsesAppOwnedKeyboard = $activityText.Contains('NamePanelKeyboard') -and $activityText.Contains('NameKeyboardPopupPanel') -and $activityText.Contains('BRB_NAME_APP_KEYBOARD_CONTRACT') -and $activityText.Contains('implementation=app_owned') -and $activityText.Contains('platformControl=AppOwnedKeyboard') -and $activityText.Contains('inputOwner=appOwnedNameKeyboard') -and $activityText.Contains('keyboardPanel=keyboard_panel') -and $activityText.Contains('presentation=pop_out_spatial_panel') -and $activityText.Contains('integratedInQuestionnaire=false') -and $activityText.Contains('appearsOnTextFieldFocus=true') -and $activityText.Contains('closeToParticipant=left_of_questionnaire_near_user') -and $activityText.Contains('placement=left_of_questionnaire_near_user') -and $activityText.Contains('radialReference=headset_center') -and $activityText.Contains('orientation=faces_headset') -and $activityText.Contains('nonObstructing=true') -and $activityText.Contains('fovVisible=true') -and $activityText.Contains('BRB_NAME_APP_KEYBOARD_PANEL_LAYOUT') -and $activityText.Contains('R.id.keyboard_panel') -and $idsText.Contains('name="keyboard_panel"') -and $activityText.Contains('noSystemImeDependency=true') -and $activityText.Contains('directAdbKeyeventValidation=true') -and $activityText.Contains('hardwareKeyeventFallback=true') -and $activityText.Contains('keyDownCommit=true') -and $activityText.Contains('batchedTextEventFallback=true') -and $activityText.Contains('nativeLikeRows=true') -and $activityText.Contains('prerenderedPreview=true') -and $activityText.Contains('dragHandle=true') -and $activityText.Contains('controllerBeamDraggable=true') -and $activityText.Contains('BRB_NAME_APP_KEYBOARD_DRAG')
    nameKeyboardPanelAspectMatched = $activityText.Contains('NAME_KEYBOARD_PANEL_DISPLAY_WIDTH_DP') -and $activityText.Contains('NAME_KEYBOARD_PANEL_DISPLAY_HEIGHT_DP') -and $activityText.Contains('DpDisplayOptions(') -and $activityText.Contains('width = NAME_KEYBOARD_PANEL_DISPLAY_WIDTH_DP') -and $activityText.Contains('height = NAME_KEYBOARD_PANEL_DISPLAY_HEIGHT_DP') -and $activityText.Contains('NAME_KEYBOARD_PANEL_WIDTH_METERS = 0.64f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_HEIGHT_METERS = 0.25f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_DISPLAY_WIDTH_DP = 1040f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_DISPLAY_HEIGHT_DP = 406f') -and $activityText.Contains('aspectMatched=true') -and $activityText.Contains('comfortableDistance=true') -and $activityText.Contains('higherLargerCloser=true') -and $activityText.Contains('nativeLikeRows=true')
    nameKeyboardHigherLargerCloserLeftPlacement = $activityText.Contains('NAME_KEYBOARD_PANEL_RADIAL_ANGLE_DEGREES = -20f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_RADIAL_DISTANCE_METERS = 0.86f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_Y_METERS = 1.30f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_MIN_RADIAL_ANGLE_DEGREES = -42f') -and $activityText.Contains('NAME_KEYBOARD_PANEL_MAX_RADIAL_ANGLE_DEGREES = -6f')
    nameKeyboardPreviewRenderer = (Test-Path $keyboardPreviewScriptPath) -and $keyboardPreviewScriptText.Contains('name-keyboard-popup-preview.png') -and $keyboardPreviewScriptText.Contains('aspectMatched') -and $keyboardPreviewScriptText.Contains('comfortableDistance') -and $keyboardPreviewScriptText.Contains('higherLargerCloser') -and $keyboardPreviewScriptText.Contains('controllerBeamMovableContract') -and $keyboardPreviewScriptText.Contains('keyShapeNativeLike') -and $keyboardPreviewScriptText.Contains('NAME_KEYBOARD_PANEL_DISPLAY_WIDTH_DP')
